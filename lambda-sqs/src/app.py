...
# Regardless of a transactions "BOP status", a copy of all transactions must go to their respective Banks' SNS Topic.
...
def lambda_handler(event, context):
    ...
    print('Is transaction reportable: ', reportable_value)
